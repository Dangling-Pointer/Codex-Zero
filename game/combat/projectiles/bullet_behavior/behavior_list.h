...
{
public:
    explicit BounceBehavior(int bounces, float restitution = 1.0f)
        : _remaining_bounces(bounces), _restitution(restitution)
    {
    }

    void on_fire(BulletBehaviorContext &context) override;
...
// Bullets continue flight after a collision for a limited number of hits.
...
private:
    ...
    elysia::core::Vector2 _last_collision_direction = elysia::core::Vector2::zero();
    ...
    elysia::core::Vector2 _stored_velocity;
};
