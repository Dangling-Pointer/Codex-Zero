...
namespace game::scene
{
    ...
    void MainMenuScene::build_menu_buttons()
    {
        ...
        ui_button->set_on_click([this] {
            Scene::request_scene_switch(game::scene_keys::RoomScene);
        ...
        ui_label->set_typography_role(elysia::typography::UiTypographyRole::Title);
        ...
        */
        ...
        std::unique_ptr<elysia::ui::UiImage> codex_image =
            std::make_unique<elysia::ui::UiImage>(ELYSIA_RESOURCES->find_texture("ui.codex_zero"),
                elysia::core::Rect{ 0,0,512,168 });

        std::unique_ptr<elysia::ui::UiListContainer> ui_outer_list =
            std::make_unique<elysia::ui::UiListContainer>(elysia::core::Rect{ 0, 0, 600, 600 });
        
        //ui_outer_list->add_front(std::move(ui_label));
        ui_outer_list->add_front(std::move(codex_image));
